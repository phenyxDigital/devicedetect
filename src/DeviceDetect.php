...
class DeviceDetect {
    ...
    public function __construct(
        ...
        // to something other than a string, an DeviceDetectException exception will be thrown.
     ...
     * @return bool
     * @throws DeviceDetectException
     */
    public function isMobile(): bool {

        if (!$this->hasUserAgent()) {
            throw new DeviceDetectException('No valid user-agent has been set.');
        }
        ...
        try {
            ...
            throw new DeviceDetectException("Cache problem in isMobile(): {$e->getMessage()}");
        }
    ...
    public function isTablet(): bool {
        ...
        if (!$this->hasUserAgent()) {
            throw new DeviceDetectException('No user-agent has been set.');
        }
...
//                if (is_array($_regex)) {
            ...
            throw new DeviceDetectException("Cache problem in isTablet(): {$e->getMessage()}");
        }
    ...
    public function is(string $ruleName): bool {
        ...
        try {
            ...
            throw new DeviceDetectException("Cache problem in is(): {$e->getMessage()}");
        }
